...
export const AddressAdd: React.FC = () => {
  ...
  const fetchStates = async (countryId: string) => {
    ...
    try {
      const response = await axios.post('https://heritage.bizdel.in/app/consumer/services_v11/getStateByCountryId', formData);
  ...
  const fetchCities = async (stateId: string) => {
    ...
    try {
      const response = await axios.post('https://heritage.bizdel.in/app/consumer/services_v11/getCityByStateId', formData);
  ...
  const updateAddress = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('https://heritage.bizdel.in/app/consumer/services_v11/updateAddress', formData);
  ...
  const addAddress = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('https://heritage.bizdel.in/app/consumer/services_v11/addAddress', formData);
  ...
  const renderHeader = (): JSX.Element => {
    return <components.Header title={newAddress.id ? 'Update Address' : 'Add Address'} showGoBack={true} />;
  };
