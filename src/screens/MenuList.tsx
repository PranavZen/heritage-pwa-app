...
export const MenuList: React.FC = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>(product_cat_id);

  console.log("selectedCategory",selectedCategory);

  // ********************************
  const [filterData, setFilterData] = useState<DishType[]>([]);
  const [filterDataLoading, setFilterDataDishesLoading] = useState<boolean>(false);
              ...
              >
                <div
                  style={{
                    ...
                    borderColor: selectedCategory === category.product_cat_id
                      ? 'var(--main-turquoise)'
                      : 'var(--white-color)',
                    backgroundColor: 'var(--white-color)',
                  }}
                >
                  <h5
                    style={{
                      ...
                      color: selectedCategory === category.product_cat_id  
                        ? 'var(--main-turquoise)'
                        : 'var(--main-color)',
                    }}
                  >
